...
export default function Login() {
    ...
    return (
        <main className={styles.container}>
            ...
            <h1 className={styles.title}>chizzle 가입하기</h1>
            <form className={styles.form} action={formAction}>
                <label className={styles.label}>이메일</label>
                <input type="email" id="email" placeholder="name@example.com" className={styles.input} />
                <label className={styles.label}>chizzle 이름</label>
                <input type="text" id="username" placeholder="chizzle 이름" className={styles.input} />
